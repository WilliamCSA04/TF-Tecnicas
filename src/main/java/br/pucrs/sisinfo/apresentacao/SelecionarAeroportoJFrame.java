...
public class SelecionarAeroportoJFrame extends javax.swing.JFrame {
    ...
    @Inject
    public SelecionarAeroportoJFrame(AeroportoDao dao, JFrame parent) {
        //super(parent);
        this.dao = dao;
        this.parent = parent;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionarAeroportoJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                SelecionarAeroportoJFrame selecionarAeroporto = injector.getInstance(SelecionarAeroportoJFrame.class);
